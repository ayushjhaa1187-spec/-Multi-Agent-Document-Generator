...
export async function POST(req: Request) {
  ...
  try {
    ...
    // ⚡ BOLT OPTIMIZATION: Removed redundant database health check (SELECT 1) from the hot path.
    // This saves 10-50ms of database latency per chat request by trusting the Prisma connection pool
    // and letting actual database operations fail naturally if there are connection issues.
