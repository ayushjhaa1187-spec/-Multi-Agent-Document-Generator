...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Performance optimization: Removed unnecessary SELECT 1 health check on every request.
    // Prisma maintains its own connection pool and handles connection state.
    // Removing this saves 10-50ms per chat request.
