...
export async function POST(req: Request) {
  ...
  try {
    ...
    // ⚡ Bolt Optimization: Removed synchronous DB health check to improve Time-To-First-Token (TTFT) as database interaction is deferred to the onFinish callback.
