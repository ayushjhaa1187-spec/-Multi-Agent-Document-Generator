...
export async function POST(req: Request) {
  ...
  try {
    ...
    // ⚡ Bolt Optimization: Removed synchronous `SELECT 1` check to improve Time-To-First-Token (TTFT).
    // Database connectivity errors during the save phase are handled asynchronously in the `onFinish` callback.
