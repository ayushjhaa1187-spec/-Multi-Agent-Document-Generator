...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Prisma automatically manages connection pooling. Explicit health checks on every request
    // add unnecessary network latency (10-50ms+). We now rely on natural query failures.
