...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Optimization: Removed explicit `SELECT 1` database health check.
    // Prisma manages its own connection pool, making manual pings redundant
    // and adding unnecessary network latency (10-50ms+) to every API request.
