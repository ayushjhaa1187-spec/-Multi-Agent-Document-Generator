...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Optimization: Removed redundant explicit database health check (prisma.$queryRaw`SELECT 1`)
    // to reduce unnecessary network latency on every request. Prisma's connection pool handles health.
