...
// ⚡ Bolt Optimization: Extracted chat message into a React.memo component to prevent O(N²) re-renders of the entire message list during Vercel AI SDK text streaming.
