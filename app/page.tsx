...
// Extracted message item into a React.memo component to prevent unnecessary re-renders.
// Since message objects are immutable in the messages array, this avoids re-rendering
// the entire list every time the user types in the input or a new message is appended.
// Expected Impact: Reduces re-renders of list items by 100% when input changes.
const ChatMessage = memo(function ChatMessage({ message, stage }: { message: Message, stage: string }) {
  return (
    <div
