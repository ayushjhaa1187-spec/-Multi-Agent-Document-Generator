...
// Memoized message item to prevent O(N^2) re-renders during Vercel AI SDK text streaming.
// Only the actively streaming message will re-render, saving CPU cycles.
