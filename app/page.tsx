...
export default function BRDGenerator() {
  ...
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    handleSubmit(e);
    // Defer height reset to ensure DOM has updated after clearing input
    setTimeout(() => {
      if (textareaRef.current) {
        textareaRef.current.style.height = 'auto';
      }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {projectName && (
          <>
            ...
            {/* Input Form */}
            <form ref={formRef} onSubmit={handleFormSubmit} className="glass-card p-6 sm:p-8 shadow-2xl">
