...
const MessageItem = memo(function MessageItem({ message, stage }: { message: { id: string, role: string, content: string }, stage: string }) {
  return (
    <div
            ...
            <div className="chat-container glass-card p-6 sm:p-8 mb-6 shadow-2xl min-h-[400px] sm:min-h-[500px] max-h-[600px] overflow-y-auto">
              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  <MessageItem key={message.id} message={message} stage={stage as string} />
                ))}
