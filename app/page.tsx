...
// ⚡ Bolt Optimization: Extracted message into a memoized component.
// This prevents O(N²) re-renders during AI text streaming by ensuring
// that only the actively updating message re-renders, while completed ones do not.
const MessageItem = memo(({ message, stage }: { message: { id: string, role: string, content: string }, stage: 'clarify' | 'generate' }) => (
  <div
