        ...
        {projectName && (
          <>
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                onClick={() => {
                  if (messages.length > 0 && !window.confirm('Are you sure you want to change projects? This will clear your current conversation.')) {
                    return;
                  }
                  setProjectName('');
                  setProjectNameInput('');
                ...
                className="text-gray-400 hover:text-white text-sm transition-colors rounded px-2 py-1 outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                aria-label="Change project and clear conversation"
              >
                Change Project
              </button>
            </div>
