...
// ⚡ Bolt Optimization: Wrapped in React.memo() to prevent unnecessary re-renders of all previous
// messages' buttons every time a new text chunk streams in from the AI SDK.
