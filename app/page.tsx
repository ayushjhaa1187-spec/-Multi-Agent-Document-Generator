...
// ⚡ Bolt Optimization: Wrap CopyButton in React.memo() to prevent unnecessary re-renders
// during typing and AI streaming for messages that have already been fully generated.
