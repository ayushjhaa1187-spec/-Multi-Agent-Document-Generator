 ...
 * Why: When Vercel AI SDK streams text chunks, the messages array updates continuously.
 * Without memoization, every inline component inside the map re-renders on every chunk, causing O(N²) renders.
 * Impact: Reduces rendering from O(N²) to O(1) operations by only rendering the actively streaming message.
 */
