 ...
 * What: Extracted message rendering into a standalone memoized component.
 * Why: Vercel AI SDK's useChat triggers a re-render of the parent component on every streaming text chunk.
 *      By wrapping individual messages in React.memo(), we prevent re-rendering already complete messages.
 * Impact: Reduces rendering operations from O(N²) to O(1) during active text streaming.
 */
