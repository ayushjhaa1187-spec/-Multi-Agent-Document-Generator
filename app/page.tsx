...
/**
 * @optimization
 * Why: Vercel AI SDK's `useChat` streams text token-by-token. Rendering the entire message list directly inside the parent component forces all messages to re-render on every single token update.
 * Impact: Reduces rendering operations from O(N^2) to O(N). Only the actively streaming message re-renders.
 */
