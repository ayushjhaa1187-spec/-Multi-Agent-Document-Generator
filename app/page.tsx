...
// ⚡ Bolt Optimization: Memoize CopyButton to prevent re-renders when parent re-renders
...
// ⚡ Bolt Optimization: Memoize ChatMessage to prevent O(n^2) re-renders during text streaming
const ChatMessage = memo(function ChatMessage({ message, stage }: { message: any, stage: string }) {
  return (
    <div
