...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders of all copy buttons
// during typing or when new messages are streaming. It only re-renders if 'content' changes.
