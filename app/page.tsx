...
/**
 * Optimization: Extracted message rendering into a memoized component.
 * Why: Vercel AI SDK's useChat hook triggers frequent re-renders during text streaming.
 * Impact: Reduces O(N^2) re-renders to O(N) by preventing unchanged messages from re-rendering.
 */
