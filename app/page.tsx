...
// Extracted to prevent O(N^2) re-renders during streaming
// Impact: Reduces rendering cost from O(N^2) to O(1) per streaming chunk
const ChatMessage = memo(function ChatMessage({ message, stage }: { message: { id: string, role: string, content: string }; stage: 'clarify' | 'generate' }) {
  return (
    <div
