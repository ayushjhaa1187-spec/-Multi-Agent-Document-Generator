...
// Optimization: Memoize the chat message component to prevent O(n) re-renders
// of the entire message history during streaming token updates.
const ChatMessage = React.memo(({ message, stage }: { message: Message, stage: string }) => {
  return (
    <div
