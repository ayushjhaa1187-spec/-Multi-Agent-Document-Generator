        ...
        {projectName && (
          <>
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                onClick={() => {
                  if (window.confirm('Are you sure you want to change projects? This will clear your current conversation history.')) {
                    setProjectName('');
                    setProjectNameInput('');
                    setStage('clarify');
                    setMessages([]);
                ...
                aria-label="Change project (Warning: clears history)"
              >
                Change Project
              </button>
            </div>
