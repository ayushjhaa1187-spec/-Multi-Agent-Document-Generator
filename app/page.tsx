...
// ⚡ Bolt Optimization: Memoize Chat Messages to prevent unnecessary re-renders of older messages during streaming
const ChatMessageItem = memo(function ChatMessageItem({ message, stage }: { message: Message, stage: 'clarify' | 'generate' }) {
  return (
    <div
            ...
            <div className="chat-container glass-card p-6 sm:p-8 mb-6 shadow-2xl min-h-[400px] sm:min-h-[500px] max-h-[600px] overflow-y-auto">
              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  <ChatMessageItem key={message.id} message={message} stage={stage} />
                ))}
