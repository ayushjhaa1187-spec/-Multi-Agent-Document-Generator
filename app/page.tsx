...
// During streaming token updates, useChat triggers frequent re-renders.
// React.memo prevents O(n) re-renders of the entire message history
// by only re-rendering the message that is currently updating.
