...
// ⚡ Bolt Optimization: Extracted ChatMessage and wrapped in React.memo() to prevent O(N²) re-renders of the entire message list during text streaming from useChat.
