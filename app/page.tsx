...
// ⚡ Bolt Optimization: Extracted the message element into a standalone MemoizedMessage
// component wrapped in React.memo(). This prevents older messages from re-rendering
// on every chunk while a new message is streaming, eliminating an O(N²) re-render bottleneck.
const MemoizedMessage = React.memo(({ message, stage }: { message: { id: string, role: string, content: string }, stage: string }) => (
  <div
