...
// ⚡ Bolt Optimization: Extracted inline message rendering into a React.memo() component.
// This prevents previous messages from re-rendering every time a new chunk streams in or the input changes.
// Expected Impact: Reduces unnecessary re-renders in the chat list by O(n) per state update.
