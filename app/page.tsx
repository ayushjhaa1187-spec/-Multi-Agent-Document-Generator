...
// ⚡ Bolt Optimization:
// Extracted the message rendering into a separate component and wrapped it in React.memo().
// This prevents O(N²) re-renders of the entire message history on every streamed chunk from the AI.
