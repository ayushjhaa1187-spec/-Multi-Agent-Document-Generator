...
// ⚡ Bolt Optimization: Wrapped CopyButton in React.memo() to prevent unnecessary re-renders of all previous message copy buttons during typing and message streaming
