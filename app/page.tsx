...
// Extracted inline message rendering into a memoized component.
// When using Vercel AI SDK text streaming, the parent component re-renders on every streamed chunk.
// React.memo prevents O(N^2) re-renders by ensuring only the actively streaming message updates.
const ChatMessage = memo(({ message, stage }: { message: { id: string, role: string, content: string }, stage: string }) => (
  <div
