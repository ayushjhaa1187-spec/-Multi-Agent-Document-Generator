...
// ⚡ Bolt: Memoizing CopyButton prevents unnecessary re-renders of static UI elements
// during the frequent state updates caused by AI message streaming in the parent component.
