...
// During streaming token updates, useChat frequently updates the messages array.
// Wrapping individual messages in React.memo() prevents O(n) re-renders of the entire
// message history for every single token received, reducing CPU usage and layout thrashing.
