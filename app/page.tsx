...
// ⚡ Bolt Optimization: Memoize individual message components to prevent O(N²) re-renders during text streaming
const MessageItem = React.memo(({ message, stage }: { message: Message; stage: 'clarify' | 'generate' }) => (
  <div
