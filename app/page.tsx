...
// ⚡ Bolt Optimization: Memoize the ChatMessage component to prevent re-rendering entire message lists
// when new tokens are streamed via the AI SDK. Reduces unnecessary re-renders of older, unchanged messages by O(N).
