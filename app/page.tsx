 ...
 * Why: Vercel AI SDK text streaming causes inline mapped items to re-render on every new chunk.
 * Impact: Extracting into a React.memo wrapped standalone component reduces O(N^2) re-renders to O(1).
 */
