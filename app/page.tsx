...
// Extracted message item into a memoized component.
// During streaming, the messages array updates continuously. Memoizing individual messages
// prevents O(n) re-renders of the entire chat history for every token received,
// reducing CPU usage and maintaining smooth scrolling.
