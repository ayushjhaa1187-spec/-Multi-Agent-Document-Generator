...
// Extracted individual message item into a React.memo component.
// This prevents O(n) DOM re-renders of the entire message history
// during streaming token updates from useChat, significantly
// reducing CPU usage and improving UI responsiveness.
const MessageItem = React.memo(({ message, stage }: { message: Message, stage: string }) => (
  <div
