...
// ⚡ Bolt Optimization: Extract message item to a memoized component to prevent O(N²) re-renders of the entire message list during text streaming.
const MessageItem = memo(({ message, stage }: { message: any; stage: string }) => {
  return (
    <div
