...
// ⚡ Bolt Optimization: Memoize the chat message component to prevent O(N²) re-renders of the entire list during text streaming
const ChatMessage = React.memo(({ message, stage }: { message: Message; stage: 'clarify' | 'generate' }) => (
  <div
