 ...
 * Why: Vercel AI SDK's useChat updates the messages array on every streaming token.
 *      Rendering the messages inline causes O(N^2) re-renders for the entire list.
 * Impact: Wrapping individual messages in React.memo reduces re-renders to O(1),
 *         meaning only the currently streaming message updates, significantly improving performance.
 */
