...
class AnalyticsTracker {
  ...
  trackError(error: Error | string, context?: Record<string, any>): void {
    // 🛡️ Sentinel: Sanitize stack traces to prevent sensitive information exposure via public analytics endpoint
    // Log full error internally for observability
    console.error('[Analytics] Internal Error Log:', error, context);
