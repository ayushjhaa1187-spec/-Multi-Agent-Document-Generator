...
class AnalyticsTracker {
  ...
  trackError(error: Error | string, context?: Record<string, any>): void {
    ...
    // 🛡️ Sentinel: Sanitized stack trace from analytics event to prevent information leakage via the public /api/analytics endpoint. Error details are preserved in server logs.
