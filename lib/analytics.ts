...
class AnalyticsTracker {
  ...
  trackError(error: Error | string, context?: Record<string, any>): void {
    ...
    // 🛡️ Sentinel: Sanitize stack traces before exposing to analytics
    // Stack traces must be removed from the tracker to prevent leaking internal
    // paths or logic via public endpoints like /api/analytics
    if (error instanceof Error && error.stack) {
      console.error('[Analytics Error Logger]:', error.stack);
    }
