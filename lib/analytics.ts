...
class AnalyticsTracker {
  ...
  trackError(error: Error | string, context?: Record<string, any>): void {
    ...
    // 🛡️ Sentinel: Omit stack traces from analytics events to prevent information leakage via the unauthenticated /api/analytics endpoint. Full traces are retained in server logs.
