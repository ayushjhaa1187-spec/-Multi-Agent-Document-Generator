...
class AnalyticsTracker {
  ...
  trackError(error: Error | string, context?: Record<string, any>): void {
    ...
    // 🛡️ Sentinel: Removed stack trace from tracked event properties to prevent information leakage
    // since the analytics events are exposed publicly via the /api/analytics endpoint.
